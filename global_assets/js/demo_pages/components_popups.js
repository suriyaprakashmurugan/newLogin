...
var Popups = function () {
    ...
    var _componentPopoverEvents = function() {
		...
		$('#popover-show').popover({
			title: 'Popover title',
			content: 'And here1\'s some amazing content. It\'s very engaging. Right?',
			trigger: 'click'
		...
		$('#popover-shown').popover({
			title: 'Popover title',
			content: 'And here2\'s some amazing content. It\'s very engaging. Right?',
			trigger: 'click'
		...
		$('#popover-hide').popover({
			title: 'Popover title',
			content: 'And here3\'s some amazing content. It\'s very engaging. Right?',
			placement: 'top',
			trigger: 'click'
		...
		$('#popover-hidden').popover({
			title: 'Popover title',
			content: 'And here4\'s some amazing content. It\'s very engaging. Right?',
			trigger: 'click'
